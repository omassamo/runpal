 ...
 <!--  <a id="all" href="runpal_results.php">
  ...
  <div class="dropdown">
    ...
    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
      <form action="resultest.php" method="post">
      <li role="presentation"><input type="submit" name="foo" value="All cities"/><a role="menuitem" tabindex="-1" href="#"></a></li>
...
<?php 
    ...
    while($row = mysql_fetch_array($result)){
          if(strlen($row['city']) > 0){
            ...
            echo "<li><input type='submit' name='foo' value='" . $row['city'] . "' role='presentation'><a role='menuitem' tabindex='-1' href='#'/></a></li>";
          }
          };
